...
import 'package:flutter_drag_animation/video/round_slider_track_shape.dart';
...
class VideoPage extends StatefulWidget {
  const VideoPage({Key? key,required this.videoPlayerController,required this.heroTag}) : super(key: key);
...
class _VideoPageState extends State<VideoPage> implements DragListener{
  ...
  void initState() {
    super.initState();
    DragListenerManager.addListener(this);
    initializePlayer();
  }
  ...
  void dispose() {
    _timer?.cancel();
    _hideTimer?.cancel();
    DragListenerManager.removeListener(this);
    super.dispose();
  }
        ...
        body: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              _animationFinish && !_isDragging && !_videoPlayerController.value.isPlaying &&
                  ((!_videoPlayerController.value.isInitialized) || _videoPlayerController.value.isBuffering) ?
              const Center(
                child: SizedBox(
                  width: 53,
                  height: 53,
              ...
              Center(
                child: !_videoPlayerController.value.isInitialized || _isPlaying ? Container() :
                GestureDetector(
                  onTap: onTap,
                  child: const Icon(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Opacity(
                    opacity: _pageDragging ? 0 : _isDragging ? 1 : 0.5,
                    child: SliderTheme(
